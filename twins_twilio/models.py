...
def phone_number_to_json(pn: dict, base_url: str) -> dict:
    ...
    return {
        ...
        "voice_url": _nullable_str(pn.get("voice_url")),
        "voice_method": pn.get("voice_method", "POST"),
        "voice_fallback_url": _nullable_str(pn.get("voice_fallback_url")),
        "voice_fallback_method": pn.get("voice_fallback_method", "POST"),
        "sms_url": _nullable_str(pn.get("sms_url")),
        "sms_method": pn.get("sms_method", "POST"),
        "sms_fallback_url": _nullable_str(pn.get("sms_fallback_url")),
        "sms_fallback_method": pn.get("sms_fallback_method", "POST"),
        "status_callback": _nullable_str(pn.get("status_callback")),
